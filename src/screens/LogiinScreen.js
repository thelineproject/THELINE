...
import { SigninUser, setErrorMsg, facebookAuth, googleAuth } from '../redux/actions/actions';
import { validateEmail } from '../utils/uuidValidate';

export default function LogiinScreen({ navigation }) {
  ...
  const submit = () => {
    if (email === '') {
      ...
      setisLoader(true)
      dispatch(SigninUser(email, password, setisLoader, navigation))
    }
  }
    ...
    >
      <ScrollView
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.inputsContainer}>
            ...
            <View>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('PasswordRecovery')}>
                <Text style={{
                  ...styles.emailadreesText,
                  alignSelf: 'flex-end', marginRight: RFValue(20)
          ...
          >
            <Text style={{ color: 'black' }}>Dont have an account yet?</Text>
          </TouchableOpacity>
