...
import { StyleSheet, Image, Text, View, ImageBackground, TextInput,SafeAreaView,TouchableOpacity,navigation} from "react-native"
import { useFonts } from 'expo-font'

export default function Loginemail({ errorText, description, ...props }) {
    ...
    <View style={styles.Loginemail}>
      <View style={styles.LoginContainer}>
        ...
        secureTextEntry
          ...
          <TouchableOpacity onPress={() => navigation.navigatey('Signup')}>
            
          <Text style={styles.LoginTxt949}>LOGIN</Text>
          ...
          <TouchableOpacity style={styles.Group28}>
            <Image
              style={styles.Image9}
              source={{
          ...
          <TouchableOpacity style={styles.Group27}>
            <Image
